...
def jwslab_load_bio_data(napari_viewer: napari.Viewer, file_path: Path,
    ...
    try:
        ...
        if file_extension == ".tiff" or file_extension == ".tif":
            ...
            napari_viewer.add_image(transformed_data,channel_axis=0,
            ...
            with tifffile.TiffFile(file_path) as tiff:
                ...
                if x_resolution and y_resolution:
                    ...
                    x_res_value = x_res[0] / x_res[1] if isinstance(x_res, tuple) else x_res
                    y_res_value = y_res[0] / y_res[1] if isinstance(y_res, tuple) else y_res
                    xyz: dict = {
                        "x": x_res_value,
                        "y": y_res_value,
                        "z": z_physical_size,
